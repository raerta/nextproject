...
import { getPostsByUser, resetPostState } from "@/lib/features/post/postSlice";
...
const PostListByUser = ({ searchQuery }: { searchQuery: string }) => {
  ...
  useEffect(() => {
    if (id) {
      dispatch(getPostsByUser({ id: id, limit: limit, page: page }));
    }
